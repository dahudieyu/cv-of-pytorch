...
train_path = glob.glob('RaceData/Tianchi/mchar_train/*.png')
train_path.sort()
train_json = json.load(open('RaceData/Tianchi/mchar_train.json'))
...
val_path = glob.glob('RaceData/Tianchi/mchar_val/*.png')
val_path.sort()
val_json = json.load(open('RaceData/Tianchi/mchar_val.json'))
...
test_path = glob.glob('RaceData/Tianchi/mchar_test_a*.png')
test_path.sort()
